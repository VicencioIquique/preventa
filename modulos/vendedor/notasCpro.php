        ...
        <div id="one"> <form action="" method="GET" id="horizontalForm">
            ...
            <fieldset>
				<legend>Ingresar Fechas</legend>
							 ...
							 <input name="opc" type="hidden" id="opc" size="40" class="required" value="notaCredito" />
...
WHERE     (dbo.RP_ReceiptsDet_SAP.Bodega = '".$modulo."')  AND 
                      (dbo.RP_ReceiptsDet_SAP.TipoDocto <> 1) AND (dbo.RP_ReceiptsDet_SAP.TipoDocto <> 4)
 AND (dbo.RP_ReceiptsCab_SAP.FechaDocto >= '".$finicio2." 00:00:00.000') AND (dbo.RP_ReceiptsCab_SAP.FechaDocto <= '".$ffin2." 23:59:59.000') ".$Wvendedor." ".$Wmarca." ".$Wcodbarra." ORDER BY dbo.RP_ReceiptsCab_SAP.FechaDocto" ;
							...
							exit( "Error en la consulta SQL" );
							  ...
							  {
									echo '<tr style="" title="Anula Documento: '.$tipoDocto.'-'.$caja.'-'. $bodega.'-'. $nroDocto.' ">';
									...
									echo traerNulo (1,$caja,$modulo,$nroDocto,$resultado["Sku"]);
