...
<div class="idTabs">
      <ul>
		...
		?>
		      <li><a href="../SISAP/modulos/vendedor/topvendedoresex.php?modulo=<?php echo $modulo; ?>&inicio=<?php echo $finicio2; ?>&fin=<?php echo $ffin2; ?>"><img src="images/excel.png" width="30px" height="30px" /></a></li>
		<?php }?>
	 </ul>
      <div class="items">
							...
							exit( "Error en la consulta SQL" );
							  ...
							  while($resultado = odbc_fetch_array($rs)){ 
							   echo '<tr>
									...
									<td ><strong>'.number_format($resultado["SumaTotal"], 0, '', '.').'</strong></td> ' ;
									$total = $total + $resultado["SumaTotal"];
